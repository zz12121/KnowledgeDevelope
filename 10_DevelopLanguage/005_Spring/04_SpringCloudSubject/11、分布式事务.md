...
📖 [[../../../../27_SpringCloudKnowledge/07_安全与分布式事务/01、安全认证与分布式事务#四、分布式事务]]
...
```
**优缺点**：优点是强一致性保证，对业务侵入小；缺点是同步阻塞、单点故障、数据不一致风险。
...
📖 [[../../../../27_SpringCloudKnowledge/07_安全与分布式事务/01、安全认证与分布式事务#五、Seata]]
...
```
**优缺点**：避免长时间资源锁定，适合长事务；但补偿操作实现复杂，难以保证原子性。
...
- **秒杀活动**：本地消息表+异步处理
- **实时交易**：TCC模式
**技术选型参考**：2PC/XA强一致、性能低、复杂度低，适合传统银行金融核心；TCC最终一致、性能高、复杂度高，适合电商互联网金融；Saga最终一致、性能中、复杂度中，适合长业务流程微服务；本地消息表最终一致、性能高、复杂度中，适合异步消息场景。
