...
📖 [[../../../../27_SpringCloudKnowledge/06_链路追踪与监控/01、链路追踪与监控#一、链路追踪概述]]
...
📖 [[../../../../27_SpringCloudKnowledge/06_链路追踪与监控/01、链路追踪与监控#二、Spring Cloud Sleuth]]
...
📖 [[../../../../27_SpringCloudKnowledge/06_链路追踪与监控/01、链路追踪与监控#三、Zipkin]]
...
📖 [[../../../../27_SpringCloudKnowledge/06_链路追踪与监控/01、链路追踪与监控#四、SkyWalking对比]]

###### 10. SkyWalking 与 Zipkin 的区别是什么？
简单说，**Zipkin是专注链路追踪的轻量级工具，SkyWalking是完整的APM系统**。
最大的区别在于**接入方式**：Zipkin依赖SDK集成，有一定代码侵入性；SkyWalking基于Java Agent字节码增强，真正无侵入，直接挂载到JVM即可追踪，无需改动任何业务代码。
**功能范围**：Zipkin专注于分布式追踪；SkyWalking集成了追踪、指标、日志的完整APM体系，UI功能更丰富（拓扑图、性能矩阵等），是活跃的Apache项目，迭代更快。
