...
|     | 单体应用、SOA、微服务架构有什么区别？              |     |     |
|     | 微服务架构下如何做到高可用？                    |     |     |
|     | 什么是服务注册与发现？它在微服务架构中的作用是什么？        |     |     |
|     | 你们是如何拆分微服务的？                      |     |     |
|     | 微服务架构下，你们分布式事务是怎么处理的？             |     |     |
|     | 说说 Seat 中 AT 模式的处理过程              |     |     |
|     | Seata 事务模式有几种？                    |     |     |
|     | 什么是 Spring Cloud ？                |     |     |
|     | Spring Boot和Spring Cloud之间的区别与关系  |     |     |
|     | Spring Cloud Alibaba包含哪些核心组件？     |     |     |
|     | Spring Cloud 有什么优势                |     |     |
...
|     | 为什么需要负载均衡？常见的负载均衡算法有哪些？           |     |     |
|     | 为什么 Nacos 需要一致性协议                 |     |     |
|     | 为什么 Nacos 选择了 Raft 以及 Distro      |     |     |
|     | 说说 Nacos 的 CP 模型和 AP 模型           |     |     |
|     | 配置中心是如何实现自动刷新的？                   |     |     |
|     | 配置中心是如何保证数据安全的?                   |     |     |
|     | 什么是服务网关?                          |     |     |
|     | 网关的作用是什么                          |     |     |
...
|     | Gateway与Zuul的区别是什么？               |     |     |
|     | Gateway的过滤器有哪些类型？                 |     |     |
|     | 如何在Spring Cloud Gateway中实现限流？     |     |     |
|     | 什么是 Predict（断言）？                  |     |     |
|     | Spring Cloud Sleuth的工作原理是什么？      |     |     |
|     | Zipkin如何与Spring Cloud集成？          |     |     |
|     | 说说 OAuth 2.0 与单点登录的区别？            |     |     |
